...
#+BEGIN_SRC text
  We tried configuring IDAPython for your system; the configuration succeeded with the following output:

  ----------
  Checking installs from "Python Software Foundation"
  Checking "Python 3.12 (64-bit)" (3.12)
  Found: "C:\Python312\" (version: 3.12.6 ('3.12.6150.1013'))
  no "Applying version 3.12.6 ('3.12.6150.1013')
  ----------

  If you want to reconfigure IDAPython for a different Python version, please run the command-line tool idapyswitch.
#+END_SRC

#+BEGIN_SRC text
    IMPORTANT NOTE!

    You have successfully installed IDA on your computer.  This installation requires a license file.

    Please copy your ida.hexlic file to IDA installation directory or to "%APPDATA%\Hex-Rays\Ida Pro" directory before launching IDA.
